...
public class MarkBlockTrigger extends SimpleCriterionTrigger<MarkBlockTrigger.TriggerInstance> {
    ...
    @Override
    public MarkBlockTrigger.TriggerInstance createInstance(JsonObject pJson, ContextAwarePredicate pPredicate, DeserializationContext pDeserializationContext) {
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance {
        ...
        public TriggerInstance(ContextAwarePredicate pPlayer, @Nullable Block pBlock, StatePropertiesPredicate pState) {
