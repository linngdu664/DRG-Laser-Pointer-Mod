...
public class SoundRegistry {
    public static final DeferredRegister<SoundEvent> SOUNDS = DeferredRegister.create(Registries.SOUND_EVENT, DrgLaserPointer.MODID);
    ...
    public static DeferredHolder<SoundEvent, SoundEvent> registerHelper(String name) {
        return SOUNDS.register(name, () -> SoundEvent.createVariableRangeEvent(DrgLaserPointer.makeMyIdentifier(name)));
    }
}
