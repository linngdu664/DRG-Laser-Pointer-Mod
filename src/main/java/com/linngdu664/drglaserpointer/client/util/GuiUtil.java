...
public class GuiUtil {
    public static void fill(GuiGraphics guiGraphics, float minX, float minY, float maxX, float maxY, int color) {
        ...
        vertexconsumer.vertex(matrix4f, minX, minY, 0).color(color).endVertex();
        vertexconsumer.vertex(matrix4f, minX, maxY, 0).color(color).endVertex();
        vertexconsumer.vertex(matrix4f, maxX, maxY, 0).color(color).endVertex();
        vertexconsumer.vertex(matrix4f, maxX, minY, 0).color(color).endVertex();
